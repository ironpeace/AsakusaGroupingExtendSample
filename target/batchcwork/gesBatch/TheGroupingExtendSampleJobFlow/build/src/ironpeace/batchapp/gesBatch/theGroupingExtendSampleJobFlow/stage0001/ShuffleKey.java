...
@SuppressWarnings("deprecation") public final class ShuffleKey implements SegmentedWritable {
    ...
    /**
     * GroupingExtendSampleOperator.join4Mid#t11が利用するキー (userid)
     */
    public StringOption groupElem0Term1 = new StringOption();
    /**
     * GroupingExtendSampleOperator.join4Mid#t11のキーの元になるモデルオブジェクトを設定する
    ...
    /**
     * GroupingExtendSampleOperator.join4Mid#t12のキーの元になるモデルオブジェクトを設定する
     * @param source 設定するモデルオブジェクト
     */
